    ...
    <div className="flex absolute -translate-y-full -left-[1px] ">
      {tabsList.map((tab, index) => (
        <button
          ...
          className="min-w-[125px] border border-gray-300 border-t border-x py-2 px-3 mr-4 font-bold bg-slate-50 hover:bg-slate-200 text-slate-700 rounded-t focus:outline-none focus:ring-2 ring-inset focus:ring-blue-300 border-b-0 "
        >
          {tab.name}
        </button>
      ))}
