...
function Header() {
  return (
    <header className='py-6 px-8 bg-white/80 backdrop-blur-md border-b border-gray-100 sticky top-0 z-50'>
      <div className='max-w-7xl mx-auto flex items-center justify-between'>
        <div className='flex items-center gap-3'>
          ...
          <div>
            ...
            <p className='text-xs text-gray-500 font-medium'>CSS Box Shadow Generator</p>
          </div>
        </div>
        <a
